...
const About = () => {
  return (
    <article className='main__container'>
      ...
      <aside>
        <AsideList  number='1' subtitle='Track company-wide progress' 
        ...
        />
        <AsideList  number='2' subtitle='Advanced built-in reports' 
        ...
        />
        <AsideList  number='3' subtitle='Everything you need in one place' 
